...
class _$ScheduleTearOff {
  ...
  _Schedule call({required List<ScheduleItem> item}) {
    return _Schedule(
      item: item,
    );
  }
...
/// @nodoc
mixin _$Schedule {
  List<ScheduleItem> get item => throw _privateConstructorUsedError;
...
abstract class $ScheduleCopyWith<$Res> {
  ...
  $Res call({List<ScheduleItem> item});
}
...
class _$_Schedule implements _Schedule {
  const _$_Schedule({required this.item});

  factory _$_Schedule.fromJson(Map<String, dynamic> json) =>
      _$$_ScheduleFromJson(json);

  @override
  final List<ScheduleItem> item;
...
abstract class _Schedule implements Schedule {
  const factory _Schedule({required List<ScheduleItem> item}) = _$_Schedule;

  factory _Schedule.fromJson(Map<String, dynamic> json) = _$_Schedule.fromJson;

  @override
  List<ScheduleItem> get item;
  @override
  @JsonKey(ignore: true)
  _$ScheduleCopyWith<_Schedule> get copyWith =>
      throw _privateConstructorUsedError;
